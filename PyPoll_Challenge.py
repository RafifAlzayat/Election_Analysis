...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        county_dictionary[county_name] = county_dictionary[county_name] + 1

print("=============================")
print(county_list)
print(county_dictionary["Jefferson"])
print(county_dictionary["Denver"])
print(county_dictionary["Arapahoe"])
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_dictionary:
        ...
        votes = county_dictionary.get(county_name)
